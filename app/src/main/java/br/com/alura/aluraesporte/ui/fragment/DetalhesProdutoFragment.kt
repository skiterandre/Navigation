...
class DetalhesProdutoFragment : Fragment() {
    ...
    private val viewModel: DetalhesProdutoViewModel by viewModel { parametersOf(argumentos.produtoId) }
    ...
    private fun vaiParaPagamento() {
        val directions = DetalhesProdutoFragmentDirections.actionDetalhesProdutoToPagamento(produtoId = argumentos.produtoId)
